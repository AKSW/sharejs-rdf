(function() {
  var RdfJsonDoc, RdfJsonOperation, SparkMD5, WEB, cloneExportTriples, cloneTriples, exportTriplesIntersect, hashTripleObject, jsonld, md5, rdfJson, sharejs;
  ...
  rdfJson = {
    ...
    transform: function(op1, op2, side) {
      var op1First, op1t, triplesIntersect, triplesIntersectCount, _ref;
      op1t = op1.clone();
      op1First = side === 'right';
      ...
      if (op2.operation() === RdfJsonOperation.prototype.OP_INSERT) {
